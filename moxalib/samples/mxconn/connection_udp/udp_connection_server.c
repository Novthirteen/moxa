...
*/
/*
    udp_connection_server.c

    Routines to simulate a simple UDP server.
...
static void
udp_server_close_client(MHANDLE conp, void *private_data)
{
	(void) conp;
	/* free what was malloced at udp_server_accept_client */
...
#endif
{
    ...
    connection_dispatch_loop(argc, argv, udp_server_init, NULL, 0);
